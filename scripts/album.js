...
var createSongRow = function(songNumber, songName, songLength) {    
    var time = parseFloat(songLength);
    var wholeMinutes = Math.floor(time / 60);
    var wholeSeconds = Math.floor(time - wholeMinutes * 60);
    var formatTime = null

    if (wholeSeconds >= 10) {
        formatTime = wholeMinutes + ":" + wholeSeconds;
    }else{
       formatTime = wholeMinutes + ":0" + wholeSeconds; 
    }
    ...
    + '  <td class="song-item-duration">' + formatTime + '</td>'
    + '</tr>'
    ;
...
var setCurrentTimeInPlayerBar = function(currentTime){
    ...
    var curTime = $(".current-time").html(formatTime);
};

var setTotalTimeInPlayerBar = function(){
    var time = parseFloat(currentSongFromAlbum.duration);
    var wholeMinutes = Math.floor(time / 60);
    var wholeSeconds = Math.floor(time - wholeMinutes * 60);
    var formatTime = null;
    ...
    var totTime = $(".total-time").html(formatTime);
};
